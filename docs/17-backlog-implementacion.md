...
| TC-008-fe 🟢 | Sidebar admin persistente + ADMIN mantiene menú completo en todas las vistas admin — CERRADO 2026-08-11 (tourya-front PRs #96, #109). Al desplegar FE-15b/c (BackofficeGuard), el sidebar se perdía en algunas vistas y ADMIN veía solo los 3 ítems del subset BACKOFFICE. Fix: sidebar admin persistente en shell + guards mantienen los items visibles según rol (ADMIN ve todo, BACKOFFICE_OPERATION solo 3: reservas, payouts, DIMAR). Ver actualización en doc 12 §Roles y layout admin | P1 | S | FE-15b | Issue #195 |
