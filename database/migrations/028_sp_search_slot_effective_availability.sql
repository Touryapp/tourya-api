-- Migration: Exponer y filtrar disponibilidad de slot como GREATEST(0, capacity - bookings)
-- Date: 2026-04-08
--
-- La columna tour_schedule_config_slot.availability puede quedar en 0 si no se recalcula
-- mientras capacity/bookings son correctos; el search mostraba 0 y el carrito usaba solo
-- max_capacity - reserved del día. Alineamos JSON y filtros requestedUnits con el cálculo efectivo.
