-- Migration 029: Quitar capacidad a nivel tour_schedule y tour_schedule_config.
-- Capacidad efectiva solo en tour_schedule_config_slot (capacity, bookings, availability)
-- y tour.is_unlimited_capacity para tours ilimitados.
-- Date: 2026-04-08
...
ALTER TABLE public.tour_schedule
  ...
  DROP COLUMN IF EXISTS reserved_capacity,
  DROP COLUMN IF EXISTS is_unlimited_capacity;
