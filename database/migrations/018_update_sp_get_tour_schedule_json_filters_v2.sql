-- Migration: Update sp_get_tour_schedule_json to support subcategory/durationEnum/timeOfDay and include new tour fields
-- Date: 2026-03-31
-- Notes:
-- - This builds on the latest definition in 004_fix_sp_get_tour_schedule_json.sql
