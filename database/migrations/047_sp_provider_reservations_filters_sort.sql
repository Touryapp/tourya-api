-- Filtro por subcategoría de tour en gestión de reservas del proveedor
...
CREATE OR REPLACE FUNCTION public.sp_get_provider_reservations(
    p_provider_id integer DEFAULT NULL::integer,
    p_reservation_id bigint DEFAULT NULL::bigint,
    p_delivery_status character varying DEFAULT NULL::character varying,
    p_sub_category character varying DEFAULT NULL::character varying
)
RETURNS TABLE(
