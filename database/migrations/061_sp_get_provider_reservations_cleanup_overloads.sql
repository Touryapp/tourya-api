-- Limpia TODAS las firmas viejas del SP y deja solo la de 5 parámetros (051).
-- Ejecutar en LOCAL si GET /reservations falla con "bad SQL grammar".
-- Seguro aunque ya hayas corrido 051 o 059.
